...
namespace ContainerKiller
{
    class NetworkMemory
    {
        ...
        public NetworkMemory(List<ContainerDetails> containers, string network)
        {
            ...
            var subnet = DockerEngineService.GetDockerSubnet(network);
            ...
            {
                for(var i = intIp; i < uint.MaxValue; i++)
                {
